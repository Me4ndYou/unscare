...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="{{url('/home')}}"><i class="fas fa-home"></i> <span class="messenger-headTitle">BACK HOME</span> </a>
                {{-- header buttons --}}
        ...
        <div class="m-header m-header-messaging">
            <nav>
                ...
                <div style="display: inline-flex;">
                    ...
                    <a href="#" class="user-name">UNS CARE Messenger</a>
                </div>
                {{-- header buttons --}}
                <nav class="m-header-right">
                    <a href="#" class="add-to-favorite"><i class="fas fa-star"></i></a>
                    <!-- <a href="{{url('/home')}}"><i class="fas fa-home"></i></a> -->
                    <a href="#" class="show-infoSide btn"><i class="fas fa-info"></i></a>
                </nav>
            </nav>
        </div>
        {{-- Internet connection --}}
